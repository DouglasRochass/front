...
class ProdutoService {
  ...
  async obter(id) {
    try {
      ...
      return { success: false, message: error.message || 'Produto não encontrado', error };
    }
  }
  ...
  async criar(produtoData) {
    try {
      ...
      return { success: true, data: response.data || response, message: 'Produto criado com sucesso' };
    } catch (error) {
      console.error('[ProdutoService.criar] Erro:', error);
      return { success: false, message: error.message || 'Erro ao criar produto', error };
    }
  }
  ...
  async atualizar(id, produtoData) {
    try {
      ...
      return { success: true, data: response.data || response, message: 'Produto atualizado com sucesso' };
    } catch (error) {
      console.error('[ProdutoService.atualizar] Erro:', error);
      return { success: false, message: error.message || 'Erro ao atualizar produto', error };
    }
  }
  ...
  async deletar(id) {
    try {
      ...
      return { success: false, message: error.message || 'Erro ao deletar produto', error };
    }
  }
  ...
  async listarPorCategoria(categoria, filtros = {}) {
    try {
      ...
      return { success: false, message: error.message || 'Erro ao listar produtos por categoria', error };
    }
  }
  ...
  async listarPorMercado(mercadoId, filtros = {}) {
    try {
      ...
      return { success: false, message: error.message || 'Erro ao listar produtos', error };
    }
  }
